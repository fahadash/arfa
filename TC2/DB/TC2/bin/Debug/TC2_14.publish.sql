...
GO
PRINT N'Dropping DF__tmp_ms_xx__Creat__4AB81AF0...';


GO
ALTER TABLE [dbo].[Table] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__4AB81AF0];


GO
PRINT N'Dropping DF__tmp_ms_xx__Suspe__4BAC3F29...';


GO
ALTER TABLE [dbo].[Table] DROP CONSTRAINT [DF__tmp_ms_xx__Suspe__4BAC3F29];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Table] ([TableId], [TableName], [OwnerUserId], [Created], [Suspended], [Timestamp])
        SELECT   [TableId],
                 [TableName],
                 [OwnerUserId],
                 [Created],
...
GO
PRINT N'Altering [dbo].[fn_GetUserIdByToken]...';


GO
ALTER FUNCTION [dbo].[fn_GetUserIdByToken]
(
...
END
GO
PRINT N'Altering [dbo].[usp_ListJoinableTables]...';


GO
ALTER PROCEDURE [dbo].[usp_ListJoinableTables]
	@LoginToken UNIQUEIDENTIFIER
AS
	DECLARE @UserId INT
