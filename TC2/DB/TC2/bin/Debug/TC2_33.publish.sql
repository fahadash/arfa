...
CREATE TABLE [dbo].[Table] (
    ...
    [GameStarted]         BIT           NOT NULL,
    [HandsAccumulated]    INT           NOT NULL,
    [TurnStart]           BIT           NOT NULL,
...
CREATE TABLE [dbo].[TableUser] (
    ...
    CONSTRAINT [PK_TableUser] PRIMARY KEY CLUSTERED ([TableUserId] ASC)
);
...
GO
ALTER TABLE [dbo].[Table]
    ADD DEFAULT 0 FOR [HandsAccumulated];
...
GO
ALTER TABLE [dbo].[Table]
    ADD DEFAULT 1 FOR [TurnStart];


GO
PRINT N'Creating Default Constraint on [dbo].[TableUser]....';
...
GO
PRINT N'Creating FK_Table_User1...';


GO
ALTER TABLE [dbo].[Table]
    ADD CONSTRAINT [FK_Table_User1] FOREIGN KEY ([LastWinnerUserId]) REFERENCES [dbo].[User] ([UserId]);
...
GO
PRINT N'Creating [dbo].[fn_EmptyGUID]...';
...
END
GO
PRINT N'Creating [dbo].[fn_GetUserIdByToken]...';
...
END
GO
PRINT N'Creating [dbo].[usp_ChangePassword]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[usp_RegisterUser]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[usp_UpdateTokenHit]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[usp_CreateTable]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[usp_GetTableTimestamp]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[usp_JoinTable]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[usp_ListTablesUserIsOn]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[usp_ListUserTables]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[usp_SuspendTable]...';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '9cd74775-86c6-4de0-8d77-a62c56071e73')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('9cd74775-86c6-4de0-8d77-a62c56071e73')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'c42e25ee-f627-4e33-8001-8a7c9b492089')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('c42e25ee-f627-4e33-8001-8a7c9b492089')
