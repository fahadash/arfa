...
namespace TCService2._2.Database
{
	...
	public partial class Card : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<TableHistory> _TableHistories;
    ...
    partial void OnCardAliasChanged();
		...
		public Card()
		{
			...
			this._TableHistories = new EntitySet<TableHistory>(new Action<TableHistory>(this.attach_TableHistories), new Action<TableHistory>(this.detach_TableHistories));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Card_TableHistory", Storage="_TableHistories", ThisKey="CardId", OtherKey="CardId")]
		public EntitySet<TableHistory> TableHistories
		{
			get
			{
				return this._TableHistories;
			}
			set
			{
				this._TableHistories.Assign(value);
			}
		}
		...
		private void attach_TableHistories(TableHistory entity)
		{
			this.SendPropertyChanging();
			entity.Card = this;
		}
		
		private void detach_TableHistories(TableHistory entity)
		{
			this.SendPropertyChanging();
			entity.Card = null;
		}
    ...
    partial void OnTokenLastHitChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_TableHistory", Storage="_TableHistories", ThisKey="UserId", OtherKey="UserId")]
		public EntitySet<TableHistory> TableHistories
		{
			get
			{
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnTableHistoryIdChanging(long value);
    ...
    partial void OnCardIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TableHistoryId", AutoSync=AutoSync.OnInsert, DbType="BigInt NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Card_TableHistory", Storage="_Card", ThisKey="CardId", OtherKey="CardId", IsForeignKey=true)]
		public Card Card
		{
			get
			{
			...
			set
			{
							...
							|| (this._Card.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Card.Entity = null;
						previousValue.TableHistories.Remove(this);
					}
					this._Card.Entity = value;
					if ((value != null))
					{
						value.TableHistories.Add(this);
						this._CardId = value.CardId;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_TableHistory", Storage="_User", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true)]
		public User User
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Table_TableHistory", Storage="_Table", ThisKey="TableId", OtherKey="TableId", IsForeignKey=true)]
		public Table Table
		{
			get
			{
	...
	public partial class Table : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _TrumpChooser;
    ...
    partial void OnTrumpChooserChanging(System.Nullable<int> value);
    partial void OnTrumpChooserChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TrumpChooser", DbType="Int")]
		public System.Nullable<int> TrumpChooser
		{
			get
			{
				return this._TrumpChooser;
			}
			set
			{
				if ((this._TrumpChooser != value))
				{
					this.OnTrumpChooserChanging(value);
					this.SendPropertyChanging();
					this._TrumpChooser = value;
					this.SendPropertyChanged("TrumpChooser");
					this.OnTrumpChooserChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Table_TableHistory", Storage="_TableHistories", ThisKey="TableId", OtherKey="TableId")]
		public EntitySet<TableHistory> TableHistories
		{
			get
			{
